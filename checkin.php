...
$result = $conn->query($sql);
  ...
  while($row = $result->fetch_assoc()) {
    ...
    <tr><td class='td-table'>$user1</td><td> &nbsp;</td></tr>
    <tr><td class='td-table'>$user2</td><td> &nbsp;</td></tr>
    <tr><td class='room-table' width=150 height=50 colspan='2'><input type='radio' class='custom-radio' name='id' value='$id'>$room</td></tr>
</table>";
